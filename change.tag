...
this.on('updated', function () {
  leafletUI.changeTag.dialog = leafletUI.changeTag.dialog
      || document.querySelector('#change-tile-server-dialog');
  leafletUI.changeTag.tileServerList = leafletUI.changeTag.tileServerList
      || leafletUI.changeTag.dialog.querySelector('#tile-server-list');
